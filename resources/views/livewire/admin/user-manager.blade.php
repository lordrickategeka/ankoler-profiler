<div class="p-6">
    ...
    <!-- Email & Phone List Tab -->
    <div class="mt-6">
        <ul class="flex border-b">
            <li class="mr-1">
                <button wire:click="$set('activeTab', 'users')"
                    class="inline-block py-2 px-4 text-gray-600 hover:text-blue-600 border-b-2 border-transparent hover:border-blue-600 focus:outline-none"
                    :class="{ 'border-blue-600 text-blue-600': activeTab === 'users' }">
                    Users
                </button>
            </li>
            <li class="mr-1">
                <button wire:click="$set('activeTab', 'emails-phones')"
                    class="inline-block py-2 px-4 text-gray-600 hover:text-blue-600 border-b-2 border-transparent hover:border-blue-600 focus:outline-none"
                    :class="{ 'border-blue-600 text-blue-600': activeTab === 'emails-phones' }">
                    Emails & Phones
                </button>
            </li>
        </ul>
        <div class="mt-4">
            @if ($activeTab === 'users')
                                                ...
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        @if ($user->current_team_id)
                                                            <div class="text-sm opacity-50">Team ID:
                                            ...
                                            <td>
                                                @if ($user->person_affiliation && $user->person_affiliation->organization)
                                                    ...
                                                    <div class="text-sm text-gray-500">
                                                        {{ $user->person_affiliation->organization->code }}</div>
                                                @else
                                            ...
                                            <td>
                                                <div class="flex flex-wrap gap-1">
                                                    @forelse($user->roles as $role)
                                                        <div class="badge badge-outline badge-sm">{{ $role->name }}
                                                        </div>
                                                    @empty
                                    ...
                                    <div class="form-control">
                                        <label class="label cursor-pointer justify-start">
                                            <input type="checkbox" wire:model="selectedRoles"
                                                value="{{ $role->id }}" class="checkbox checkbox-primary mr-3">
                                            <div>
                    ...
                    <div class="modal modal-open">
                        <div class="modal-box">
                            ...
                            <div class="form-control">
                                ...
                                <select wire:model="selectedOrganization" class="select select-bordered w-full">
                            ...
                            <div class="modal-action">
                                <button wire:click="closeModals" class="btn">Cancel</button>
                                <button wire:click="updateUserOrganization" class="btn btn-primary">Update
                                    Organization</button>
                            </div>
                        </div>
                    </div>
                @endif
                <div>
                    <!-- Existing content for users tab -->
                </div>
            @elseif ($activeTab === 'emails-phones')
                <!-- Emails & Phones Tab Content -->
                <div>
