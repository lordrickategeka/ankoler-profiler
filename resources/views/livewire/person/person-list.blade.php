<div class="h-[calc(100vh-8rem)] overflow-y-auto" wire:key="person-list-component">
    <div class="p-8">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex space-x-2">
                ...
                <a href="{{ route('persons.create', ['edit' => $person->id]) }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-500 hover:bg-blue-600">
                    <svg class="-ml-1 mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
    ...
    <div x-data="{ open: false }">
        <button @click="open = true" class="btn btn-primary">Edit Person</button>

        <div x-show="open" class="modal">
            <div class="modal-box">
                <h3 class="font-bold text-lg">Edit Person</h3>
                <form wire:submit.prevent="updatePerson">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" wire:model.defer="editPersonData.given_name" class="input input-bordered w-full" placeholder="Enter given name">
                            @error('editPersonData.given_name')
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" wire:model.defer="editPersonData.family_name" class="input input-bordered w-full" placeholder="Enter family name">
                            @error('editPersonData.family_name')
                                <span class="text-red-600 text-xs">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-control">
                            <label class="label pb-1">
                                <span class="label-text text-sm font-medium">Email <span class="text-red-500">*</span></span>
                            </label>
                            <input type="email" wire:model.defer="editPersonData.email" class="input input-bordered w-full" placeholder="Enter email">
                            @error('editPersonData.email')
                                <span class="text-red-600 text-xs">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-control">
                            <label class="label pb-1">
                                <span class="label-text text-sm font-medium">Phone <span class="text-red-500">*</span></span>
                            </label>
                            <input type="text" wire:model.defer="editPersonData.phone" class="input input-bordered w-full" placeholder="Enter phone number">
                            @error('editPersonData.phone')
                                <span class="text-red-600 text-xs">{{ $message }}</span>
                            @enderror
                        </div>
                    </div>
