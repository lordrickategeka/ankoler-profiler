...
class OrganisationSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $mulago = Organisation::create([
            'legal_name' => 'Mulago National Referral Hospital',
            'display_name' => 'Mulago Hospital',
            'code' => 'MNRH001',
            'category' => 'hospital',
            'registration_number' => 'H-2023-001',
            'tax_identification_number' => 'TIN-H001',
            'country_of_registration' => 'UGA',
            'date_established' => '1962-01-15',
            'website_url' => 'https://mulagohospital.go.ug',
            'contact_email' => 'info@mulagohospital.go.ug',
            'contact_phone' => '+256414532280',
            'description' => 'Uganda\'s largest national referral hospital providing specialized medical services.',
            'address_line_1' => 'Mulago Hill',
            'city' => 'Kampala',
            'district' => 'Kampala',
            'country' => 'UGA',
            'regulatory_body' => 'Ministry of Health',
            'license_number' => 'MOH-H-001',
            'license_issue_date' => '2023-01-01',
            'license_expiry_date' => '2025-12-31',
            'accreditation_status' => 'ACCREDITED',
            'primary_contact_name' => 'Dr. Baterana Byarugaba',
            'primary_contact_title' => 'Executive Director',
            'primary_contact_email' => 'ed@mulagohospital.go.ug',
            'primary_contact_phone' => '+256414532280',
            'bank_name' => 'Bank of Uganda',
            'default_currency' => 'UGX',
            'timezone' => 'Africa/Kampala',
            'hospital_details' => [
                'hospital_type' => 'referral_hospital',
                'ownership_type' => 'government',
                'bed_capacity' => 1500,
                'operating_theaters' => 12,
                ...
                'has_radiology' => true,
                'has_ambulance' => true,
                'medical_license_number' => 'ML-2023-001',
                'moh_registration_number' => 'MOH-001',
                'nhis_accreditation' => true,
                'insurance_providers' => ['NHIS', 'AAR', 'APA'],
                'specializations' => ['surgery', 'internal_medicine', 'pediatrics', 'obstetrics_gynecology', 'cardiology'],
                'accreditations' => ['ISO_9001'],
                'emergency_hotline' => '+256312230000'
            ]
        ]);

        $nsambya = Organisation::create([
